<template>
	<div class="card">
		...
		<a @click="onView" class="card__link" href="#">
		...
		<button @click="onCompare" class="card__compare"><img src="../assets/compare.svg" alt="Compare" width="24" height="24"></button>
...
<script>
	export default {
		...
		methods: {
			...
			onCompare() {
				this.$emit('compare', this.product)
			}
		},
		computed: {
			isProductAvailable() {
